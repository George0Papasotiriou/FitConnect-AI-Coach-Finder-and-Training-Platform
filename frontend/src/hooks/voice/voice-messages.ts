...
const actionNavigateSchema = z.object({
  type: z.literal("action_navigate"),
  target: z.string(),
});

const actionClickSchema = z.object({
  type: z.literal("action_click"),
  label: z.string(),
});

const actionLogRepSchema = z.object({
  type: z.literal("action_log_rep"),
  exercise: z.string(),
  reps: z.number().int(),
  weight: z.number().optional().nullable(),
});

const actionSwitchExerciseSchema = z.object({
  type: z.literal("action_switch_exercise"),
  exercise: z.string(),
});
